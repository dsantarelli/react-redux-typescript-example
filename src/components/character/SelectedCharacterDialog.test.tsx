...
import SelectedCharacterDialog from './SelectedCharacterDialog';
...
describe('SelectedCharacterDialog', () => {

    describe('should render', () => {

        it('a open dialog', () => {
            const characterDetails = { isFetching: true };
            const wrapper = shallow(<SelectedCharacterDialog isOpen={true} characterDetails={characterDetails} onClose={jest.fn()} />);
        ...
        it('a dialog that can be closed', () => {
            ...
            const characterDetails = { isFetching: true };
            const wrapper = shallow(<SelectedCharacterDialog isOpen={true} characterDetails={characterDetails} onClose={onCloseMock} />);
